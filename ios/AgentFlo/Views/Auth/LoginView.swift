...
struct LoginView: View {
    ...
    var body: some View {
        ...
        .toast("Password reset link sent! Check your email.", style: .success, isPresented: $showResetSuccess)
        .alert("Reset Password", isPresented: $showResetAlert) {
            ...
            Button("Send Reset Link") {
                ...
                Task {
                    do {
                        try await appState.authService.resetPassword(email: emailToReset)
